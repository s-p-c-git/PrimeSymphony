...
def img1_3d_spiral():
    ...
    plt.savefig(output_path("Fig1_3D_Spiral.png"), dpi=300)
    plt.close()
...
def img2_beam_schematic():
    ...
    plt.savefig(output_path("Fig2_Beam_Schematic.png"), dpi=300)
    plt.close()
...
def img3_tension_tail():
    ...
    plt.savefig(output_path("Fig3_Tension.png"), dpi=300)
    plt.close()
...
def img4_stability_decay():
    ...
    plt.savefig(output_path("Fig4_Stability.png"), dpi=300)
    plt.close()
...
def img5_gravity_well():
    ...
    ax.axis("off")
    plt.savefig(output_path("Fig5_Black_Hole.png"), dpi=300)
    plt.close()
...
def img6_quantum_levels():
    ...
    plt.savefig(output_path("Fig6_Quantum_Spectrum.png"), dpi=300, bbox_inches="tight")
    plt.close()
...
def img7_cosmic_web():
    ...
    ax.axis("off")
    plt.savefig(output_path("Fig7_Cosmic_Web.png"), dpi=300)
    plt.close()
...
def img8_laplace():
    ...
    plt.savefig(output_path("Fig8_Laplace_Proof.png"), dpi=300)
    plt.close()
...
def img9_mirror_effect():
    ...
    plt.xlabel("Error Class 1", fontsize=14)
    plt.ylabel("Error Class 2", fontsize=14)
    plt.legend(fontsize=14)
    plt.savefig(output_path("Fig9_Coupling.png"), dpi=300)
    plt.close()
...
def img10_3d_vortex():
    ...
    plt.savefig(output_path("Fig10_3D_Vortex.png"), dpi=300)
    plt.close()
...
def img12_redshift():
    ...
    plt.savefig(output_path("Fig12_Redshift.png"), dpi=300)
    plt.close()
...
if __name__ == "__main__":
    ...
    img11_spectral()
    img12_redshift()
    print("\nMaster Visualization Suite Complete. All 12 Images Saved to images/.")
