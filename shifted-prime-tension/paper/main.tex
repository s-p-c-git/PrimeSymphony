...
\author{Sadagopan Chakravarthy\thanks{Independent researcher.
ORCID: \href{https://orcid.org/0009-0004-6166-9864}{0009-0004-6166-9864}.
Correspondence: \texttt{Sadagopan.CP@gmail.com}. Code and figures:
...
The same zeros can be \emph{counted} rigorously. For the rectangle
$\Omega=\{0.1<\re s<0.9,\ |\im s|<60\}$, the argument principle (winding number
around $\partial\Omega$, evaluated to $25$ digits) gives exactly $26$ zeros for
$\zeta$ and $44$ for $L(\cdot,\chi_{-3})$, matching $2\times 13$ and $2\times 22$
on-line zeros located by sign changes (cross-checked for $\zeta$ against the
standard count). Hence every zero of both functions in $\Omega$ is simple and on
$\re(s)=\tfrac12$. This is a small-scale instance of Turing's method; at vast
scale, Platt and Trudgian~\cite{PlattTrudgian2021} verified the Riemann
hypothesis to height $3\times10^{12}$ this way.
